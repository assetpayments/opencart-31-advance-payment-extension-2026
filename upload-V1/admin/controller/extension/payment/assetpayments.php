...
class ControllerExtensionPaymentAssetPayments extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_assetpayments_declined_status_id'])) {
		    $data['payment_assetpayments_declined_status_id'] = $this->request->post['payment_assetpayments_declined_status_id'];
		} else {
		    $data['payment_assetpayments_declined_status_id'] = $this->config->get('payment_assetpayments_declined_status_id');
		}

		// Load Default Status
		if (isset($this->request->post['payment_assetpayments_default_status_id'])) {
		    $data['payment_assetpayments_default_status_id'] = $this->request->post['payment_assetpayments_default_status_id'];
		} else {
		    $data['payment_assetpayments_default_status_id'] = $this->config->get('payment_assetpayments_default_status_id');
		}
